    ...
    <>
      <section id="samples" className="py-20 px-4 relative">
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            Experience TPO-Enhanced{' '}
            <span className="text-secondary">SonicSoal</span> Sessions
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            SonicSoal subliminal tuning, designed to transform your state of
            mind and connect you to deeper levels of consciousness.
          </motion.p>
